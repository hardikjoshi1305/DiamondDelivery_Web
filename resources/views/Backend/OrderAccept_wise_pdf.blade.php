        ...
        <table style="width: 100%; border-collapse: collapse; border: 1px solid #ccc;">
            <thead>
                <tr>
                    ...
                    <th style="border: 1px solid #ccc; font-size:5px;">SNNO</th>
                    ...
                    <th style="border: 1px solid #ccc;font-size:5px;">CONTACTNO</th>
            ...
            <tbody style="max-height: 300px; overflow-y: scroll;">
                @foreach ($diamonddetails as $row)
                    <tr>
                        ...
                        <td style="border: 1px solid #ccc;font-size:5px;">{{ $row->sn_no }}</td>
                        ...
                        <td style="border: 1px solid #ccc;font-size:5px;">{{ $row->contact_no }}</td>
                        <td style="border: 1px solid #ccc;font-size:5px;">{{ $row->total }}</td>
                        <td style="border: 1px solid #ccc;font-size:5px;">{{ $row->tweight }}</td>
                        <td style="border: 1px solid #ccc;font-size:5px;">{{ $row->weight }}</td>
